// EmpsealRouterV7 ABI - with integratorId support
// This version adds bytes32 _integratorId parameter to swap functions

export const EmpsealRouterV7 =
    [
	{
		"inputs": [
			{
		...
		"inputs": [
			{
				...
				"internalType": "struct IEmpsealStructs.SplitPath[]",
				"name": "_paths",
				"type": "tuple[]"
			},
			{
