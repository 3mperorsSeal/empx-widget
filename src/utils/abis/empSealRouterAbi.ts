...
// Base-specific ABI (uses ETH-style functions)
export const BASECHAIN_ROUTER_ABI = [
    ...BASE_ROUTER_ABI,
    {
        "inputs": [
            {
...
// Sei-specific ABI (uses ETH-style functions)
export const SEI_ROUTER_ABI = [
    ...BASE_ROUTER_ABI,
    {
        "inputs": [
            {
...
// Berachain-specific ABI (uses ETH-style functions)
export const BERA_ROUTER_ABI = [
    ...BASE_ROUTER_ABI,
    {
        "inputs": [
            {
...
// Rootstock-specific ABI (uses ETH-style functions)
export const ROOTSTOCK_ROUTER_ABI = [
    ...BASE_ROUTER_ABI,
    {
        "inputs": [
            {
